...
namespace BlueSTSDK
{
    ...
    [Protocol, Model(AutoGeneratedName = true)]
    interface BlueSTSDKCOSensorFeatureDelegate : IBlueSTSDKFeatureDelegate
    {
    ...
    interface BlueSTSDKRegister
    {
        ...
        unsafe void SetHeader(BlueSTSDKRegisterHeader_t* pHeader, BlueSTSDKRegisterTarget_e target, bool write, bool ack);
        ...
        unsafe bool GetHeaderFromData(NSData data, BlueSTSDKRegisterHeader_t* pheader);
