...
namespace BlueSTSDK
{
    ...
    [BaseType(typeof(NSObject))]
    interface BlueSTSDKFeatureDelegate
    {
    ...
    [Protocol, Model(AutoGeneratedName = true)]
    [BaseType(typeof(NSObject))]
    interface BlueSTSDKFeatureLogDelegate
    {
    ...
    interface BlueSTSDKFeature_
    {
        ...
        [NullAllowed, Export("lastSample", ArgumentSemantic.Assign)]
        BlueSTSDKFeatureSample LastSample { get; set; }

        // @property (readonly, retain, atomic) NSMutableSet * _Nonnull featureDelegates;
        [Export("featureDelegates", ArgumentSemantic.Retain)]
        NSMutableSet FeatureDelegates { get; }
    ...
    [Protocol, Model(AutoGeneratedName = true)]
    [BaseType(typeof(NSObject))]
    interface BlueSTSDKNodeStateDelegate
    {
    ...
    [Protocol, Model(AutoGeneratedName = true)]
    [BaseType(typeof(NSObject))]
    interface BlueSTSDKNodeBleConnectionParamDelegate
    {
    ...
    [Protocol, Model(AutoGeneratedName = true)]
    interface BlueSTSDKDebugOutputDelegate
    {
    ...
    [Protocol, Model(AutoGeneratedName = true)]
    [BaseType(typeof(NSObject))]
    interface BlueSTSDKFeatureAutoConfigurableDelegate
    {
    ...
    [Protocol, Model(AutoGeneratedName = true)]
    [BaseType(typeof(NSObject))]
    interface BlueSTSDKFeatureBatteryDelegate
    {
    ...
    [Protocol, Model(AutoGeneratedName = true)]
    [BaseType(typeof(NSObject))]
    interface BlueSTSDKFeatureAccelerationEnableTypeDelegate
    {
    ...
    [Protocol, Model(AutoGeneratedName = true)]
    interface BlueSTSDKConfigControlDelegate
    {
    ...
    interface NSData_NumberConversion
    {
        ...
        //[Verify(MethodToProperty)]
        NSData Int16ChangeEndianes { get; }
    }
...
*/
    ...
    interface BlueSTSDKManagerDelegate
    {
